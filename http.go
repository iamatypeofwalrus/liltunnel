...
func NewHTTPTunnler(dialer Dialer, localPort string, remotePort string, cache bool, ttl int64, serveStale bool, log logger) (Tunneler, error) {
	h := &httpTunnel{
		dialer:          dialer,
		localPort:       localPort,
